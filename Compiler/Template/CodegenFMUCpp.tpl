...
case SIMCODE(modelInfo=MODELINFO(__), makefileParams=MAKEFILE_PARAMS(__), simulationSettingsOpt = sopt) then
  ...
  let platformbins = match platformstr case "win32" case "win64" then '"<%omhome%>/bin/libgcc_s_dw2-1.dll"' else ''
  let lapackbins = match platformstr case "win32" case "win64" then '"<%omhome%>/bin/lapack_win32.DLL" "<%omhome%>/bin/blas_win32.DLL"' else ''
